...
void AppClass::Update(void)
{
	...
	m_m4Sphere = glm::translate(IDENTITY_M4, vector3(2.0f, 2.0f, 0.0f));
	...
	m_m4Cube = glm::translate(IDENTITY_M4, vector3(1.5, 0, 0));

	m_m4Cone = glm::translate(IDENTITY_M4, vector3(0, 1.5, 0));

	m_m4Cylinder = glm::translate(IDENTITY_M4, vector3(-1.5, 0, 0));

	m_m4Tube = glm::translate(IDENTITY_M4, vector3(0, -1.5, 0));
