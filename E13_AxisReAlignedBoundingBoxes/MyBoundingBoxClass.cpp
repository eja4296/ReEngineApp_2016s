...
MyBoundingBoxClass::MyBoundingBoxClass(std::vector<vector3> vertexList)
{
	...
	newVertexList.push_back(vector3(m_v3Min.x, m_v3Min.y, m_v3Min.z));
	newVertexList.push_back(vector3(m_v3Min.x, m_v3Min.y, m_v3Max.z));
	newVertexList.push_back(vector3(m_v3Min.x, m_v3Max.y, m_v3Min.z));
	newVertexList.push_back(vector3(m_v3Min.x, m_v3Max.y, m_v3Max.z));
	newVertexList.push_back(vector3(m_v3Max.x, m_v3Min.y, m_v3Min.z));
	newVertexList.push_back(vector3(m_v3Max.x, m_v3Max.y, m_v3Min.z));
	newVertexList.push_back(vector3(m_v3Max.x, m_v3Min.y, m_v3Max.z));
	newVertexList.push_back(vector3(m_v3Max.x, m_v3Max.y, m_v3Max.z));
...
std::vector<vector3> MyBoundingBoxClass::GetVerticies() {
